...
<head>
    ...
    <title>Edit Rumah Sakit - Sistem Manajemen Rumah Sakit</title>
</head>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1">
            <div class="bg-white shadow-sm p-3 d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-edit text-primary"></i> Edit Rumah Sakit
                </h4>
                <div class="dropdown">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Form Edit Rumah Sakit</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('auth.rumah-sakit.update', $rumahSakit->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="telepon" value="{{ old('telepon', $rumahSakit->telepon) }}" required>
                                        @error('telepon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
