...
<head>
    ...
    <title>Edit Pasien - Sistem Manajemen Rumah Sakit</title>
</head>
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1">
            <div class="bg-white shadow-sm p-3 d-flex justify-content-between align-items-center">
                <h4 class="mb-0">
                    <i class="fas fa-edit text-primary"></i> Edit Pasien
                </h4>
                <div class="dropdown">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('auth.pasien.update', $pasien->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="no_telpon" value="{{ old('no_telpon', $pasien->no_telpon) }}"
                                            required>
                                        @error('no_telpon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
